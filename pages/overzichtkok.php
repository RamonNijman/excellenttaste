...
if (isset($_POST['submit'])){
    ...
    try {
        ...
        echo "<script>setTimeout(function(){ location.href = 'index.php?pages=overzichtkok'; }, 1200);</script>";
    } catch (PDOException $e) {
        echo $e->getMessage();
    }
}