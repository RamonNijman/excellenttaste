...
<div id="content">
    <h2>Dranken</h2>
    <?php
    // Haalt alle dranken op
    try {
        $query = "SELECT MenuItem.MenuItem, MenuItem.MenuItemCode, MenuItem.Prijs, Subgerecht.Subgerecht FROM MenuItem INNER JOIN Subgerecht ON MenuItem.SubgerechtCode = Subgerecht.SubgerechtCode WHERE MenuItem.GerechtCode = '2' ORDER BY Subgerecht.Subgerecht";
    ...
    <table class="table">
        ...
        <?php
        $soortDrank = 0;
        // Print alle dranken op het scherm, gesorteerd op subcategorie.
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success:function() {
                        ...
                        Swal.fire({
                            title: 'Verwijderd!',
                            text: "Drank is succesvol verwijderd",
                            type: 'success',
